...
import { auth, db, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, doc, getDoc, setDoc, updateDoc, serverTimestamp } from "../firebase";
...
export function useAuth() {
  ...
  return { user, profile, isAdmin, loading, login, register, logout, addPoints, redeemPoints };
}
